...
def semdist(STIM,method='cityblock'):
...
def warmstart(Sample,base_rep,dist_method,knn=0,radius=0):
    import itertools

    DIST = stimdist(Sample, base_rep, method=dist_method)
