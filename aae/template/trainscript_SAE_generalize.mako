...
% endif
  ...
  set MFHC_generalize_csv [open [file join "MFHC_generalize.csv"] w]
  loadExamples [file join "ex" "generalize.ex"] -s generalize -exmode ORDERED
  useTestingSet generalize
  errorInUnits $MFHC_generalize_csv {PhonOutput}
  close $MFHC_generalize_csv
