...
cmd_insert_performance = "INSERT INTO performance (experiment_id,sample_id,word_id,dialect_id,update_count,inputlayer,outputlayer,hit,miss,falsealarm,correctrejection,accent_id) VALUES (?,?,?,?,?,?,?,?,?,?,?,?);"
...
DIALECT_ID = aae.sql.select.dialect_id(conn, DIALECT)
EXPERIMENT_DATA = []
print "Loading data..."
